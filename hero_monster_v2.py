...
class BattleConverterGame:
    ...
    def animate_idle(self):
        ...
        if hasattr(self, 'hero_sprite'):
            ...
            current_y = self.battle_canvas.coords(self.hero_sprite)[1]
        ...
        if hasattr(self, 'monster_sprite'):
            current_y = self.battle_canvas.coords(self.monster_sprite)[1]
    ...
    def animate_hero_attack(self):
        """Animate hero attacking monster"""
        steps = 10
    ...
    def animate_monster_attack(self):
        """Animate monster attacking hero"""
        steps = 8
    ...
    def shake_screen(self):
        """Screen shake effect - shake the sprites instead of canvas"""
        shake_amount = 8
        shakes = 6
        ...
        def shake(count=0):
            if count < shakes:
                ...
                # Shake both sprites horizontally
                try:
    ...
    def check_answer(self):
        ...
        if is_correct:
            ...
            message = f"❌ Wrong! Correct: {correct} {self.current_unit_to}\n💡 Use: {tip}"
